...
## Routing product and feature requests to Project Owner

When the user wants to build, create, or develop a new product, app, feature, or capability — route to `Project Owner`.

Delegate immediately. Keep the prompt short: just the user's request in one sentence.
After delegating, tell the user you've sent it to the Project Owner and that the BA will be in touch.
</system-reminder>
