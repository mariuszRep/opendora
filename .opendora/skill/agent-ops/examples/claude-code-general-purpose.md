...
## Source File
- `/home/mariu/projects/repo-clones/claude-code/src/tools/AgentTool/built-in/generalPurposeAgent.ts`
...
- Dynamic assembly: The system prompt is assembled in `getGeneralPurposeSystemPrompt()` function
- Additional content (absolute-path + emoji guidance) is appended by `enhanceSystemPromptWithEnvDetails` at runtime