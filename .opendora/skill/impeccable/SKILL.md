...
|---|---|---|
| Context | The PRODUCT.md / DESIGN.md loader result is known from `node .opendora/skill/impeccable/scripts/load-context.mjs`. | Run the loader before continuing. |
...
```bash
node .opendora/skill/impeccable/scripts/load-context.mjs
```
...
```bash
node .opendora/skill/impeccable/scripts/pin.mjs <pin|unpin> <command>
```
