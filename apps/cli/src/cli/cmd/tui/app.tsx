...
import { Session as SessionApi } from "@projectflows/session/session"
...
function App() {
  ...
  useKeyboard((evt) => {
    if (!Flag.PROJECTFLOWS_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) return
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.PROJECTFLOWS_DISABLE_TERMINAL_TITLE) return
  ...
  command.register(() => [
    ...
    },
    {
      ...
      value: "docs.open",
      onSelect: () => {
        open("https://projectflows.ai/docs").catch(() => {})
        dialog.clear()
      },
      category: "System",
    },
  ...
  return (
    <box
      ...
      onMouseUp={Flag.PROJECTFLOWS_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? undefined : () => Selection.copy(renderer, toast)}
    >
      <Switch>
