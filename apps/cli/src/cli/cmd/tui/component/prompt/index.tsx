...
import type { FilePart } from "@projectflows/sdk/v2"
import { TuiEvent } from "../../event"
import { iife } from "@projectflows/util/iife"
import { Locale } from "@projectflows/util/locale"
import { formatDuration } from "@projectflows/util/format"
...
export function Prompt(props: PromptProps) {
  ...
  createEffect(() => {
    ...
    if (sessionID !== syncedSessionID) {
      ...
      // Only set the active agent when the session is using a primary-capable agent.
