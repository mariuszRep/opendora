...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at projectflows.ai",
  ...
  "Create {highlight}projectflows.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/projectflows/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Projectflows auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Projectflows auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Projectflows uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Projectflows from reading sensitive files",
  "Use {highlight}projectflows run{/highlight} for non-interactive scripting",
  "Use {highlight}projectflows --continue{/highlight} to resume the last session",
  "Use {highlight}projectflows run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}projectflows serve{/highlight} for headless API access to Projectflows",
  "Use {highlight}projectflows run --attach{/highlight} to connect to a running server",
  "Run {highlight}projectflows upgrade{/highlight} to update to the latest version",
  "Run {highlight}projectflows auth list{/highlight} to see all configured providers",
  "Run {highlight}projectflows agent create{/highlight} for guided agent creation",
  "Use {highlight}/projectflows{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}projectflows github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/projectflows fix this{/highlight} on issues to auto-create PRs",
