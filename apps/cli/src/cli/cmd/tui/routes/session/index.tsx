...
import type { AssistantMessage, Part, ToolPart, UserMessage, TextPart, ReasoningPart } from "@projectflows/sdk/v2"
import { useLocal } from "@tui/context/local"
import { Locale } from "@projectflows/util/locale"
import type { Tool } from "@projectflows/tools/tool"
import type { ReadTool, WriteTool, GlobTool, GrepTool, ListTool, EditTool, ApplyPatchTool } from "@projectflows/tools/filesystem"
...
import { LANGUAGE_EXTENSIONS } from "@projectflows/server/lsp/language"
  ...
  return (
    <Show when={props.part.text.trim()}>
      <box id={"text-" + props.part.id} paddingLeft={3} marginTop={1} flexShrink={0}>
        <Switch>
          <Match when={Flag.PROJECTFLOWS_EXPERIMENTAL_MARKDOWN}>
            <markdown
              syntaxStyle={syntax()}
              streaming={true}
        ...
        >
          ...
          <Show when={props.metadata.sessionId}>
            <text fg={theme.text}>
              ...
              <span style={{ fg: theme.textMuted }}> view workers</span>
            </text>
          </Show>
        </BlockTool>
      </Match>
