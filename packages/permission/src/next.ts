...
const PERMISSION_MAP: Record<string, { resource: string; access: Permission.Access }> = {
  ...
  task: { resource: "task", access: "execute" },
  question: { resource: "question", access: "execute" },
  doom_loop: { resource: "doom_loop", access: "execute" },
  skill: { resource: "skill", access: "execute" },
