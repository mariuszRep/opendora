...
import { Agent as AgentModule } from "@opendora/runtime/agent"
...
import type { AssistantMessage, Event, OpencodeClient, SessionMessageResponse, ToolPart } from "@opendora/sdk/v2"
