...
export const SqliteSessionsTable = sqliteTable(
  "sessions",
  {
    ...
    filesystemConfig: text("filesystem_config", { mode: "json" }).$type<{ enabledTools?: string[]; allowedPaths?: string[] }>(),
...
export const PgSessionsTable = pgTable(
  "sessions",
  {
    ...
    defaultPath:      pgText("default_path"),
    toolPolicy:       jsonb("tool_policy").$type<string[]>(),
    filesystemConfig: jsonb("filesystem_config").$type<{ enabledTools?: string[]; allowedPaths?: string[] }>(),
