    ...
    handles: [
      {
        ...
        connections: {
          canReceiveFrom: [
            ...
            { nodeType: NodeTypeId.Variable, handleId: null, maxConnections: "unlimited" },
          ],
        },
      },
      {
...
const BUILTIN_DEFINITIONS: NodeDefinition[] = [
  ...
  {
    type: NodeTypeId.Variable,
    name: "Variable",
    description: "Define one or more named values — strings, arrays, or objects — resolved from upstream node outputs. Supports replace and append update modes.",
    icon: "Layers",
    category: NodeCategory.Data,
    defaultConfig: {
      node: {
    ...
    version: "1.0.0",
    tags: ["variable", "data", "values", "assign", "set", "collect"],
    uiHints: {
      handles: BUILTIN_HANDLES[NodeTypeId.Variable].handles,
      constraints: BUILTIN_HANDLES[NodeTypeId.Variable].constraints,
    },
  },
]
